#!/usr/bin/python
# -*- coding: utf-8 -*-
# @Time : 2021/7/12 14:53
# @Author : Greey
# @FileName: Test_Restart.py
...
class TestClass:
    ...
    def test_restart(self):
        ...
        self.app.assert_getdevicepagename("setting_general")
        self.app.device_upslide()
        self.app.saturn_inputclick("160", "160", "160", "160")
        self.app.assert_getdevicepagename("setting_restart")
