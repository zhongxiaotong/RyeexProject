...
class Testsmoke:
    ...
    def __init__(self):
        ...
        self.mac2 = '9C:F6:DD:38:1F:DF'
        self.mac3 = '9C:F6:DD:38:1F:BE'
        self.mac4 = '9C:F6:DD:38:1D:A4'
        self.mac5 = '9C:F6:DD:38:1B:22'
        self.mac6 = '9C:F6:DD:38:1B:81'
    ...
    def smoke4(self):
        ...
        for i in range(1, 500):
            try:
                ...
                app.device_home()
                self.log.debug(info + u'按Home键成功-取消电话震动')                                                   #息屏了
                app.device_home()
    ...
    def smoke6(self):
        ...
        for i in range(1, 5000):
            try:
                self.log.debug(info + u'进入运动运行次数：' + str(i))
                app.device_upslide()
                self.log.debug(info + u'向上滑动成功')
                app.saturn_inputclick("160", "160", "160", "160")
                self.log.debug(info + u'点击运动icon成功')
                ...
                self.log.error(info + u'进入运动在第N次运行失败：' + str(i))
