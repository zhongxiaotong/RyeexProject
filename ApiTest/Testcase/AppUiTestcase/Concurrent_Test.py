...
class Testsmoke:
    ...
    def smoke1(self):
        ...
        for i in range(1, 2000):
            try:
                self.log.debug(info + '血氧心率运行次数：' + str(i))
                app.device_upslide()
                ...
                self.log.error(info + '血氧心率在第N次运行失败：' + str(i))
    ...
    def smoke2(self):
        ...
        #     try:
        #         self.log.debug(info + '滑动点击运行次数：' + str(i))
        ...
        #     except:
        #         self.log.error(info + '滑动/点击在第N次运行失败：' + str(i))
