...
# @Author : Greey
# @FileName: Test_Controlpanel_Setting.py
...
@allure.description('1：向右滑动进入控制面板，点击设置；2：检查是否进入设置页面；3：返回表盘页面')
class TestClass:
    def setup(self):
        print("Test Start")
        self.log = MyLog()
    ...
    @allure.title("控制面板-进入设置页面")
    @allure.story("正常流程")
    @allure.severity('blocker')
    @pytest.mark.baileys
    def test_controlpanel_setting(self):
        ...
        self.app.saturn_inputclick("300", "230", "300", "230")
