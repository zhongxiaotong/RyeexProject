...
father_path = os.path.abspath(os.path.dirname(current_path) + os.path.sep + "../../..")                                  #获取上上上级目录
...
class TestClass:
    ...
    def test_alarmclock(self):
        ...
        self.app.assert_getdevicepagename('alarm', 'view_set_time')
        self.app.saturn_inputslide("270", "160", "270", "40")                       #设置2分钟后的闹钟
        self.app.saturn_inputclick("180", "400", "180", "400")
