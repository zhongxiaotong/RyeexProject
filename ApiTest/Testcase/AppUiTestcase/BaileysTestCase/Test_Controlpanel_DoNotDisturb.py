#!/usr/bin/python
# -*- coding: utf-8 -*-
# @Time : 2021/7/15 15:19
# @Author : Greey
# @FileName: Test_Controlpanel_DoNotDisturb.py
...
@allure.description('1：向右滑动进入控制面板，点击打开勿扰模式；2：发送消息，检查是否有消息提醒，3：向右滑动进入控制面板，点击关闭勿扰模式，4：发送消息，检查是否有消息提醒，5：返回表盘页面')
class TestClass:
    def setup(self):
        print("Test Start")
        self.log = MyLog()
