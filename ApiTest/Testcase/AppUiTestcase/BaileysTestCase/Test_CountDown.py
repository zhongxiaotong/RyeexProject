...
class TestClass:
    ...
    def test_countdown(self):
        ...
        self.app.assert_getdevicepagename('appctr_timer', 'label_timer/list_view')
        self.app.saturn_inputclick("80", "200", "80", "200")
        self.app.assert_getdevicepagename('apptmr_inprog', 'lbl_hour/btn_stop/btn_status')
        time.sleep(60)
        self.app.assert_getdevicepagename('apptmr_inprog', 'img_timeup/lbl_str/btn_stop')
